...
@pytest.mark.parametrize(
    ...
    [(None, "connect_current"), ("NamedModel", "connect_model")],
)
...
def test_config_logger(mocker, log_level, global_level, local_level):
    ...
    mock_get_logger = mocker.patch.object(entrypoint.logging, "getLogger")
    mock_root_logger = mock_get_logger.return_value = MagicMock()
    mock_logger = mocker.patch.object(entrypoint, "juju_verify_logger")
    mock_stream_handler = mocker.patch.object(entrypoint, "stream_handler")
